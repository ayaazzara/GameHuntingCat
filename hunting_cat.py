...
score = 0 
health_point = 194 # default health point for cheese
countdown_timer = 90000 # 90 detik
arrows = [] # list of arrows

enemy_timer = 100 # waktu kemunculan
enemies = [[width, 450]] # list yang menampung koordinat musuh

# 3 - Load Game Assets ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# 3.1 - Load Images
player = pygame.image.load("assets/img/cat.png")
background = pygame.image.load("assets/img/background.jpg")
cheese = pygame.image.load("assets/img/cheese.png")
arrow = pygame.image.load("assets/img/bullet.png")
enemy_img = pygame.image.load("assets/img/mouse.png")
...
while(running):
    ...
    # draw the cheese
    screen.blit(cheese, (0, 30))
    screen.blit(cheese, (0, 135))
    screen.blit(cheese, (0, 240))
    screen.blit(cheese, (0, 345))
